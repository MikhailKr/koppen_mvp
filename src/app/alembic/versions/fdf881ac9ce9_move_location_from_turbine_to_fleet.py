...
def upgrade() -> None:
    ...
    op.add_column('windturbinefleet', sa.Column('location_id', sa.Integer(), nullable=True))
    ...
    op.drop_constraint('windturbine_location_id_fkey', 'windturbine', type_='foreignkey')
...
def downgrade() -> None:
    ...
    # Remove from fleet
    op.drop_constraint('fk_windturbinefleet_location', 'windturbinefleet', type_='foreignkey')
